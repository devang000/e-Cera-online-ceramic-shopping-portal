...
if(isset($_POST['print'])){
    ...
    $pdf->Cell(-30,215,"SONY BAZAR RAJKOT");
    $pdf->Output();
...
<body><br><br><br><br><br><br>
    <table>
        ...
        <form method="post" action="../home page/home.php">
        <tr>
